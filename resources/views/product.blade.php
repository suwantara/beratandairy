        ...
        <div class="container">
            ...
            <div class="row gx-4">
                ...
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/es-krim.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-cart"></i></a>
                            </div>
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Es Krim</a>
                            <span class="text-primary me-1">Rp 10.000</span>
                            <span class="text-decoration-line-through">Rp 15.000</span>
                        </div>
                    </div>
                ...
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/kefir.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href="product-about.html"><i class="bi bi-cart"></i></a>
                            </div>
                        </div>
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Kefir</a>
                            <span class="text-primary me-1">Rp 25.000</span>
                            <span class="text-decoration-line-through">Rp 35.000</span>
                        </div>
                    </div>
                </div>
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/keju.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-cart"></i></a>
                            </div>
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Keju Homemade</a>
                            <span class="text-primary me-1">Rp 10.000</span>
                            <span class="text-decoration-line-through">Rp 15.000</span>
                        </div>
                    </div>
                ...
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/mentega.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-cart"></i></a>
                            </div>
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Mentega</a>
                            <span class="text-primary me-1">Rp 10.000</span>
                            <span class="text-decoration-line-through">Rp 15.000</span>
                        </div>
                    </div>
                ...
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/puding.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-cart"></i></a>
                            </div>
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Puding</a>
                            <span class="text-primary me-1">Rp 10.000</span>
                            <span class="text-decoration-line-through">Rp 15.000</span>
                        </div>
                    </div>
                ...
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/sabun-susu.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-cart"></i></a>
                            </div>
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Sabun Susu</a>
                            <span class="text-primary me-1">Rp 10.000</span>
                            <span class="text-decoration-line-through">Rp 15.000</span>
                        </div>
                    </div>
                ...
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/susu-coklat.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-cart"></i></a>
                            </div>
                        ...
                        <div class="text-center p-4">
                            <a class="d-block h5" href="">Susu Rasa Cokelat</a>
                            <span class="text-primary me-1">Rp 10.000</span>
                            <span class="text-decoration-line-through">Rp 15.000</span>
                        </div>
                    </div>
                ...
                <div class="mt-4 col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="product-item">
                        <div class="position-relative">
                            <img class="img-fluid" src="img/yogurt.png" alt="">
                            <div class="product-overlay">
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-link"></i></a>
                                <a class="btn btn-square btn-secondary rounded-circle m-1" href=""><i class="bi bi-cart"></i></a>
                            </div>
